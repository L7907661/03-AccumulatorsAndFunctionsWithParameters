...
def draw_circles1(m):
    ...
    for k in  range(m):
        rad = k * 10
        circle = rg.Circle(rg.Point(200,200), rad)
...
def draw_circles2():
    window = rg.RoseWindow(400, 400)
    for k in range(18):
        rad = rg.Point(50+ (k * 20),100)
        circle = rg.Circle(rad, 10)
...
def draw_circles3():
    ...
    for k in range(100):
        rad = k + 1
        circle = rg.Circle(rg.Point(200, 150), rad)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
    """
...
def draw_cosines_and_sines():
    window = rg.RoseWindow(400, 400)
    for b in range(101):
        kk = rg.Point(200 + (80 * math.cos(b)), 200 +(80 * math.sin(b)))
        circle = rg.Circle(kk, 10)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
    """
